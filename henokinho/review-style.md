...
|---|---|
| **One finding, one proof, one sentence of consequence.** Aim at **76 words**; his own range is 57 to 97 and that is the norm to sit inside. The cut is not to the argument, it is to the repetition: **the second piece of evidence for a point already proved comes out**, and so does the restatement of the defect in the closing line. **A second finding is not a second proof.** Two defects that happen to sit on one line are two findings and both get written — compressing one out because it shares a line with the other is not concision, it is a miss. And a caveat naming what you did not check is not evidence either: it is §0, it never comes out, and it is not what you trim to reach the count. If a finding genuinely needs more room it has it — the range is the norm, not the law. What may never be cut is §0: fewer words must not become a claim with no showing of how you know. | Top-level comments, measured 2026-08-24: **him, median 78 words** (n=10 in `shema-api`; p25 58, p75 114) and **the Joãozinho bot, median 78** (n=107; p25 58, p75 97) — the same size, so writing short is not a departure from his corpus. Over his top-level comments in every repo (n=18) the median is **66**, so this target errs long, not short. Do not measure against his *replies* (n=177, median 120): a reply elaborates an argument already on the table, and that is not what you are writing. Against all of it, this bot's first real review shipped a **161-word** comment. |
